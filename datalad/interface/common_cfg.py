...
definitions = {
    ...
    'datalad.temp.fs': {
        'ui': ('question', {
               'title': 'Specify the temporary file system to use as loop device for testing DATALAD_TESTS_TEMPDIR creation'}),
    },
    'datalad.temp.fs.size': {
        'ui': ('question', {
               'title': 'Specify the size of temporary file system to use as loop device for testing DATALAD_TESTS_TEMPDIR creation'}),
    },
    'datalad.nonlo': {
        'ui': ('question', {
