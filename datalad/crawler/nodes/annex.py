...
class initiate_dataset(object):
    ...
    def _initiate_dataset(self, path, name):
        ...
        backend = self.backend or dlcfg.obtain('datalad.crawl.default_backend', default='MD5E')
        direct = dlcfg.obtain('datalad.crawl.init_direct', default=False)
        ...
        def _finalize(data):
            ...
            if cleanup:
                ...
                if total_stats.add_git or total_stats.add_annex or total_stats.merges:
                    if dlcfg.obtain('datalad.crawl.pipeline.housekeeping', default=True):
