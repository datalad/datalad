.. _man_datalad-create-sibling-gitea:
...
**-s** NAME, **-\\-name** NAME
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
name of the sibling in the local dataset installation (remote name). Constraints: value must be a string [Default: 'gitea']
...
**-\\-api** URL
~~~~~~~~~~~~~~~
URL of the Gitea instance without a 'api/<version>' suffix. Constraints: value must be a string [Default: 'https://gitea.com']
