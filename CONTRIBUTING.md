...
you need from there.  A helper you *add* there is code like any other, so accompany it
with a test in [datalad/tests/test_tests_utils_pytest.py](datalad/tests/test_tests_utils_pytest.py).
