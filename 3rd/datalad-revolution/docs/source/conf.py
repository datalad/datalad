# -*- coding: utf-8 -*-
#
# datalad_revolution documentation build configuration file, created by
...
htmlhelp_basename = 'datalad_revolutiondoc'
...
latex_documents = [
  (master_doc, 'datalad_revolution.tex', u'datalad_revolution Documentation',
